                            ...
                            jQuery(document).ready(function($){
                                ...
                                var slider = $('#vegas-slider'),
                                    slides = [
                                        ...
                                        {
                                            name: "img {{ $slider->iteration }}",
                                            src: '{{ Storage::url($slider->_get('image')) }}'
                                        }@if(! $loop->last), @endif
                                        @endforeach
                                    ],
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md col-lg-9 col-xl-8">
                            ...
                            <h2 class="__title text-white">
                                {{ $slider->_get('title') }}
{{--                                <br><span>in the World</span>--}}
                            </h2>

                            <p>
                                {{ $slider->_get('description') }}
                            </p>

                            <p class="mt-5 mt-md-10">

                                @if($slider->_get('button_text'))
                                <span class="d-none d-sm-block"><a class="custom-btn custom-btn--big custom-btn--style-3" href="{{ $slider->_get('button_link') }}">{{ $slider->_get('button_text') }}</a></span>

                                <span class="d-block d-sm-none"><a class="custom-btn custom-btn--small custom-btn--style-3" href="{{ $slider->_get('button_link') }}">{{ $slider->_get('button_text') }}</a></span>
                                @endif
    ...
    <main role="main">
        ...
        <section class="section" id="about">
            <div class="container">
                <div class="section-heading section-heading--center" data-aos="fade">
                    <h2 class="__title">
                        {{ substr($homeField->_get('about_title'), 0, strpos($homeField->_get('about_title'), ' '))}}
                        <span>{{ substr(strstr($homeField->_get('about_title')," "), 1) }}</span>
                    </h2>
        ...
        <section class="section section--no-pt section--no-pb">
            <div class="container">
                <div class="special-offer special-offer--style-1" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="70">
                    <h2 class="text text-center lazy"  data-src="img/special_offer_text_bg.jpg">
                        {{ $homeField->_get('middle_title') }}
                    </h2>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="d-none d-lg-block">
                <img id="bg-img-1" class="img-fluid lazy" src="img/blank.gif" data-src="img/agro.png" alt="demo" />
                <style type="text/css">
                    #bg-img-1
                    {
                        position: absolute;
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg-4">
                        <div data-aos="fade-left" data-aos-delay="400" data-aos-duration="500" ddata-aos-offset="100">
                            <div class="section-heading">
                                <h2 class="__title">{!! __('AGROWTH  <span>HAKKINDA</span>') !!}</h2>
                            </div>

                            <p class="d-none d-sm-block">
                                <a class="custom-btn custom-btn--medium custom-btn--style-1"
                                   href="{{ $homeField->_get('middle_url') }}">{{ __('Detaylar') }}
                                </a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4  text-center">
                        <div data-aos="fade-up" ddata-aos-duration="600" data-aos-offset="100">
                            <img class="img-fluid  lazy" src="img/blank.gif"
                                 data-src="{{ Storage::url($homeField->_get('middle_bg_1')) }}" alt="demo" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div data-aos="fade-right" data-aos-delay="400" data-aos-duration="500" ddata-aos-offset="100">
                            {!! $homeField->_get('middle_content') !!}

                            <p class="d-sm-none">
                                <a class="custom-btn custom-btn--medium custom-btn--style-1"
                                   href="{{ $homeField->_get('middle_url') }}">{{ __('Detaylar') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="__inner">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 col-xl-3">
                                <div class="__item">
                                    <div class="__intro-text">
                                        <div class="row">
                                            <div class="col-md-11">
                                                <h2>{!! __(':count Bitki <span>Besin Maddesi</span>', ['count' => $nutrients->count()]) !!}</h2>

                                                <h5>{{ __('BİTKİ SAĞLIĞINI İYİLEŞTİRMEK VE KORUMAK İÇİN') }}</h5>
                                                <p>
                                                    {{ __('Bitkiler toprak ve su minerallerini kullanarak büyür ve gelişir. Yeterli besin alamazlarsa sağlık sorunları yaşarlar, insanlar gibi. Doğru bitki beslenmesi için gübreler kullanılır (organik ve mineral) ve topraktaki besin maddeleri desteklenir.') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <style>
                                ...
                                .__item:hover .__content .__title{
                                    display: none;
                                }

                                .__item:hover .__content .__content_content{
                                    display: block;
                                }
                            </style>
                            ...
                            <div class="col-12 col-md-4 col-xl-3">
                                <div class="__item">
                                    <figure class="__image">
                                        <img class="lazy" src="img/blank.gif" data-src="{{ Storage::url($nutrient->_get('image')) }}" alt="demo" />
                                    </figure>

                                    <div class="__content">
                                        <p class="__content_content">{{ $nutrient->_get('description') }}</p>
                                        <h3 class="__title">{{ $nutrient->_get('title') }}</h3>
                                    </div>

                                    <a class="__link" href="javascript:;"></a>
                                </div>
                            </div>
                            <!-- end item -->
                            @endforeach
...
{{--                </div>--}}
        ...
        <section class="section section--dark-bg" id="contact">
            <div class="container">
                <div class="section-heading section-heading--center section-heading--white" data-aos="fade">
                    ...
                    <p>{{ __('Aşağıdaki form aracılığıyla bize mesaj iletebilirsiniz. Size en kısa sürede dönüş sağlayacağız.') }}</p>
                </div>
                ...
                <form class="contact-form js-contact-form" action="#" data-aos="fade">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="input-wrp">
                                <input class="textfield" name="name" type="text" placeholder="{{ __('İsim') }}" />
                            </div>
                        </div>

                        <div class="col-12 col-md-6">
                            <div class="input-wrp">
                                <input class="textfield" name="email" type="text" placeholder="{{ __('Email') }}" />
                            </div>
                        </div>
                    </div>

                    <div class="input-wrp">
                        <textarea class="textfield" name="message" placeholder="{{ __('Mesajın') }}"></textarea>
                    </div>

                    <button class="custom-btn custom-btn--medium custom-btn--style-3 wide" type="submit" role="button">
                        {{__('Gönder')}}</button>
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3007.53714788199!2d29.015487!3d41.079109!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab75b1f149769%3A0xd8de498feb6360e8!2sDeniz%20Alt%C4%B1!5e0!3m2!1str!2str!4v1684377832296!5m2!1str!2str" width="600" height="450"
